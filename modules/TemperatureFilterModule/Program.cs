namespace FilterModule
{
    ...
    public class Program
    {
        ...
        private static int temperatureThreshold = 24;
        ...
        private static async Task<MethodResponse> HealthCheckAsync(MethodRequest methodRequest, object userContext)
        {
            ...
            var messageBody = Encoding.UTF8.GetBytes($"Device [{Environment.GetEnvironmentVariable("IOTEDGE_DEVICEID")}], Module [TemperatureFilterModule] Running");
